InstallAutocorrect:
	...
	Gui,10: Add,Picture,x200 y0,%KodexPNG%
	Gui,10: font, s36, Courier New
	Gui,10: Add, Text,x10 y35,Kodex
	Gui,10: font, s8, Courier New
	Gui,10: Add, Text,x171 y77,%Version%
	Gui,10: font, s9, Arial
	Gui,10: Add,Text,x10 y110 Center,Kodex is initializing. This will only happen once.
	Gui,10: Color,F8FAF0
	Gui 2:+Disabled
	Gui,10: Show,auto,About Kodex
